output "service_accounts" {
  ...
  value = {
    ...
    srt_service         = google_service_account.srt_service.email
  }
}
...
output "srt_service_sa" {
  description = "SRT service service account email"
  value       = google_service_account.srt_service.email
}
