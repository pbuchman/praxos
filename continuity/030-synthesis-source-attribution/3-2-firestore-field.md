...
1. `apps/llm-orchestrator/src/domain/research/models/Research.ts` — Research type definition
2. `apps/llm-orchestrator/src/infra/research/FirestoreResearchRepository.ts` — update method
3. `apps/llm-orchestrator/src/domain/research/ports/index.ts` — ResearchRepository interface
...
npm run typecheck
npm run lint
grep -r "attributionStatus" apps/llm-orchestrator/src/
```
