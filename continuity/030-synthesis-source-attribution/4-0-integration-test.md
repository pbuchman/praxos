...
Create integration tests for the full attribution flow in llm-orchestrator.
...
1. `apps/llm-orchestrator/src/domain/research/usecases/runSynthesis.ts` — the function to test
...
- [ ] Run `npm run test -- apps/llm-orchestrator`
- [ ] Verify coverage
...
npm run test -- apps/llm-orchestrator --coverage
```
