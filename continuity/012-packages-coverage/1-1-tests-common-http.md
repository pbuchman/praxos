...
- packages/common-http/src/**tests**/jwt.test.ts
- packages/common-http/src/**tests**/fastifyAuthPlugin.test.ts
- packages/common-http/src/**tests**/response.test.ts
- packages/common-http/src/**tests**/fastifyPlugin.test.ts
- packages/common-http/src/**tests**/validation.test.ts
- packages/common-http/src/**tests**/requestId.test.ts
