...
- [x] research-agent PricingClient created (HTTP client to app-settings-service)
- [x] npm run ci passes
...
- [2026-01-06] PricingClient with 5-minute TTL cache in research-agent
...
- Done:
  ...
  - 2-0: PricingClient created in research-agent (partial - HTTP client ready)
- Now: CI passes ✅
- Next: Full integration of V2 clients with PricingClient in research-agent (future work)

## Notes

- V2 clients are created and exported, but research-agent still uses V1 clients
...
- apps/research-agent/src/infra/pricing/PricingClient.ts (new)
