# 2-0: Integration in research-agent
...
- Exported from `apps/research-agent/src/infra/pricing/index.ts`
...
- apps/research-agent/src/infra/pricing/PricingClient.ts
- apps/research-agent/src/infra/pricing/index.ts (updated)

## Notes

The infrastructure is complete. V2 clients exist and are exported from all 4 infra-\* packages.
research-agent still uses V1 clients for now - migration can happen incrementally.
