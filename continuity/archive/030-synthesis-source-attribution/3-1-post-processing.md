...
Integrate attribution validation, repair, and breakdown generation into the central synthesis researchAgent.
...
1. `apps/research-agent/src/domain/research/usecases/runSynthesis.ts` — lines 163-267
