...
1. `apps/research-agent/src/domain/research/usecases/runSynthesis.ts` — understand synthesizer interface
2. `apps/research-agent/src/infra/llm/GeminiAdapter.ts` — understand how to call synthesizer
...
```bash
rm apps/research-agent/src/domain/research/usecases/repairAttribution.ts
```
