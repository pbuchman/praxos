# TASK-05: Migrate llm-orchestrator Infra and Routes Layer
...
Replace `SupportedModel` with `ResearchModel` in llm-orchestrator infra and routes. Replace hardcoded model/provider strings with constants.
