...
1. `apps/llm-orchestrator/src/domain/research/models/Research.ts` - imports SupportedModel
2. `apps/llm-orchestrator/src/domain/research/models/index.ts` - re-exports SupportedModel
3. `apps/llm-orchestrator/src/routes/researchRoutes.ts` - imports SupportedModel
4. `apps/llm-orchestrator/src/routes/internalRoutes.ts` - imports SupportedModel
