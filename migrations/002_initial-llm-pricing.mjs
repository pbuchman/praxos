...
export async function up(context) {
  ...
  const pricingDoc = {
    models: {
      ...
      'google_gemini-2.5-flash-lite': createPricingEntry(
        'google',
      ...
      'anthropic_claude-opus-4-5-20251101': createPricingEntry(
        'anthropic',
        'claude-opus-4-5-20251101',
        5.0,
        25.0
      ),
      'anthropic_claude-sonnet-4-5-20250929': createPricingEntry(
        'anthropic',
        'claude-sonnet-4-5-20250929',
        3.0,
        15.0
      ),
      'anthropic_claude-haiku-4-5-20251001': createPricingEntry(
        'anthropic',
      ...
      'openai_o4-mini-deep-research': createPricingEntry(
        'openai',
