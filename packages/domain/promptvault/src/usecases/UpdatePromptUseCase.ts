 ...
 * UpdatePromptUseCase
 * 
 * Updates a prompt (partial update with validation).
 */

import type { Result } from '@praxos/common';
import { err } from '@praxos/common';
import type { Prompt, PromptUpdate } from '../models/Prompt.js';
...
export class UpdatePromptUseCase {
  ...
  async execute(
    ...
    return await this.repository.updatePrompt(userId, promptId, data);
  }
}
