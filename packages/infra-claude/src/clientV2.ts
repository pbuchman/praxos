/**
 * Claude Client V2 - with parameterized pricing.
 *
 * No hardcoded pricing - all costs calculated from passed ModelPricing config.
 * Original createClaudeClient() remains for backwards compatibility.
 */
...
import type { ClaudeConfigV2, ClaudeError, ResearchResult } from './types.js';
import { normalizeUsageV2 } from './costCalculator.js';

export type ClaudeClientV2 = LLMClient;
...
export function createClaudeClientV2(config: ClaudeConfigV2): ClaudeClientV2 {
